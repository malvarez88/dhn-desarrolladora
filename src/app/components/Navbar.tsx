...
const Navbar: React.FC = () => {
  ...
  return (
    <div className="fixed z-10 opacity-90">
      ...
      {menuVisible && (
        <div
          className={`fixed flex flex-col top-0 right-0 h-full w-1/4 bg-white shadow-lg p-4 transform transition-transform duration-300 ease-in-out ${
        ...
        >
          ...
          <ul className="flex flex-col gap-2 mt-24 text-3xl items-center text-neutral-900 flex-grow">
